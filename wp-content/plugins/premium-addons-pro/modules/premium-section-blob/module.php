...
class Module extends Module_Base {
	...
	public function register_controls( $element ) {
		...
		$repeater->add_control(
			...
			array(
				...
				'description' => 'Get Blob SVG code from <a href="https://www.blobmaker.app/" target="_blank">Blobmaker</a> or <a href="https://blobs.app/" target="_blank">Blobs</a>.',
	...
	public function before_render( $element ) {
		...
		if ( 'section' === $type && 'yes' === $settings['premium_blob_switcher'] && isset( $settings['premium_blob_repeater'] ) && 0 < count( $blobs ) ) {
