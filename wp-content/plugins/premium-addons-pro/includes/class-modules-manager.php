...
final class Manager {
	...
	public function extend_display_conditions_options( $data ) {
		...
		$conditions['url_referer'] = __( 'URL Parameters', 'premium-addons-pro' );

		if ( class_exists( 'woocommerce' ) ) {
			$conditions['woo_orders']        = __( 'WooCommerce Orders', 'premium-addons-for-elementor' );
			$conditions['woo_category']      = __( 'WooCommerce Cateogry', 'premium-addons-for-elementor' );
			$conditions['woo_last_purchase'] = __( 'WooCommerce Last Purchase', 'premium-addons-for-elementor' );
		}

		if ( class_exists( 'ACF' ) ) {
			$conditions['acf_choice']  = __( 'ACF Choice', 'premium-addons-for-elementor' );
			$conditions['acf_text']    = __( 'ACF Text', 'premium-addons-for-elementor' );
			$conditions['acf_boolean'] = __( 'ACF True/False', 'premium-addons-for-elementor' );
		}
