    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        var PremiumUnfoldHandler = ModuleHandler.extend({
            ...
            getDefaultSettings: function () {
                ...
                return {
                    selectors: {
                        unfoldElem: '.premium-unfold-wrap',
            ...
            getDefaultElements: function () {
                var selectors = this.getSettings('selectors'),
                    elements = {
                        $unfoldElem: this.$element.find(selectors.unfoldElem),
                    };
        ...
        var PremiumChartHandler = ModuleHandler.extend({
            ...
            bindEvents: function () {
                ...
                var $closestTab = this.elements.$chartElem.closest(".premium-tabs-content-section");
                ...
                if (!$closestTab.length) {
                    ...
                    $(document).on('click', "a[href='#/" + tabID + "']", function () {
        ...
        var PremiumTabsHandler = ModuleHandler.extend({
            ...
            getDefaultSettings: function () {
                return {
                    selectors: {
                        premiumTabsElem: '.premium-tabs-container',
            ...
            getDefaultElements: function () {
                var selectors = this.getSettings('selectors'),
                    elements = {
                        ...
                        $navList: this.$element.find(selectors.navList),
            ...
            run: function () {
                ...
                if (this.settings.carousel) {
                    ...
                    $navList.slick(this.getSlickSettings());
                ...
                if (this.settings.accordion && elementSettings.accordion_tabs_devices.includes(currentDevice)) {
                    $premiumTabsElem.find('.premium-tabs, .premium-tabs-nav-list').addClass('premium-accordion-tabs');
        ...
        window.CBPFWTabs = function (t, settings) {
            ...
            self._show = function (tabIndex, tab) {
                ...
                if (self.items.find("video").length) {
                    self.items.not(".content-current").find("video").get(0).pause();
                }

                if (self.items.find("iframe").length) {
            ...
            getSlickSettings: function () {
                ...
                return {
                    ...
                    settings: {
                        ...
                        rtl: generalSettings.rtl ? false : true,
        ...
        var PremiumImageAccordionHandler = ModuleHandler.extend({
            ...
            run: function () {
                ...
                if ($accordionElem.find('.premium-accordion-li-active').length) {
                    this.resizeImgs();
                }
        ...
        var PremiumColorTransitionHandler = ModuleHandler.extend({
                ...
                if (this.settings.isSolid) {
                    ...
                    elements.forEach(function (element, index) {
                        ...
                        elementorFrontend.waypoint(
                            ...
                            offset: (0 === index) ? 'bottom-in-view' : (_this.getElementSettings(_this.settings.offset) || 30),
                            triggerOnce: false
                        }
                        );
                        ...
                        elementorFrontend.waypoint(
                            ...
                            offset: -1 * (_this.getElementSettings(_this.settings.offset) || 30),
                            triggerOnce: false
                        }
                        );
            ...
            getRepeaterSettings: function () {
                ...
                repeater.forEach(function (element) {
        ...
        var PremiumIconBoxHandler = function ($scope, $) {
            ...
            var $iconBox = $scope.find(".premium-icon-box-container-out"),
                devices = ['widescreen', 'desktop', 'laptop', 'tablet', 'tablet_extra', 'mobile', 'mobile_extra'].filter(function (ele) { return ele != elementorFrontend.getCurrentDeviceMode(); });
        ...
        var classHandlers = {
            ...
            'premium-trustpilot-reviews': PremiumReviewHandler,
