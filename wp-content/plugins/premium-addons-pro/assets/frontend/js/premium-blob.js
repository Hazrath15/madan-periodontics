(function ($) {
    ...
    window.PremiumBlobGenerator = PremiumBlobGenerator = {
        ...
        init: function ($scope) {
            ...
            this.settings = editMode ? $scope.find('#premium-blob-gen-' + sectionId).data('blob') : $scope.data('blob');
        ...
        generateBlob: function () {
            ...
            $.each(blobs, function (index, blob) {
                ...
                if ('custom' === blob.type) {
                    ...
                    blobSource = elementorFrontend.isEditMode() ? window.PremiumWidgetsEditor.drawBlob(blob, path) : blob.source.html;
                }
